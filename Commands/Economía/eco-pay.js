...
const userEconomySchema = require("../../Schemas/economy-system/userEconomySchema");
        ...
        try {
            ...
            await client.users.cache.get(user.id).send({
                embeds: [
                    new EmbedBuilder()
                        .setDescription(
                            `You have received a total of ${amount} from ${interaction.user
                            }! This amount has been deposited to your balance and you total now is $${selectedUserBalance.balance + amount
                            }`
                        )
                        .setColor("Green")
                        .setImage(
